...
select instr('aabaacccaaacab', 'b') from dual; --b의 위치값(3번째)를 반환
select instr('aabaacccaaacab', 'b', 5,1) from dual; -- 5번째 위치에서부터 1번째 'b'의 자리를 반환
select instr('aabaacccaaacabbb', 'b', -1,1) from dual; -- 뒤에서 1번째 위치에서부터 1번째 'b'의 자리를 반환
